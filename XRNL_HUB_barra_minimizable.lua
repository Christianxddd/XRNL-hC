...
-- 🔁 Minimizar visualmente el panel en lugar de ocultarlo
task.spawn(function()
    ...
    if Rayfield then
        ...
        if Topbar then
            ...
            if Minimize and Minimize:IsA("ImageButton") then

                local originalSize = Rayfield.Size
                local originalPosition = Rayfield.Position

                local minimizedSize = UDim2.new(0, 300, 0, 45) -- barra larga y delgada
